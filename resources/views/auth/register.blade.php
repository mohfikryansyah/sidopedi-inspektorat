        ...
        <div class="w-full max-w-md p-6 space-y-8 sm:p-8 bg-gray-50 rounded-lg shadow">
            ...
            <form class="mt-8 space-y-5" method="POST" action="{{ route('register') }}">
                ...
                <div class="flex justify-between">
                    ...
                    @endif --}}
                    <div class="md:text-base text-xs font-medium text-gray-500 dark:text-gray-400">Sudah punya akun?<a href="/login" class="text-yellow-400"> Sign In</a>
                    </div>
                </div>
                <button type="submit"
                    class="w-full px-5 py-2 text-base font-medium text-center text-white bg-yellow-400 hover:bg-yellow-500 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto ">Register</button>
